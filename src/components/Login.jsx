...
const Login = () => {
  ...
  return (
    <div className="bg-[url(bg.png)] w-screen h-screen bg-no-repeat bg-cover flex justify-center items-center">
      <Header />
      <div className="bg-black/90 flex flex-col justify-evenly items-center text-white w-[80%] max-w-xl rounded-2xl px-5 lg:px-14 py-10">
        ...
        <form className="flex flex-col w-full gap-3">
          ...
          />
          <button className="bg-red-600 py-3 mt-4 rounded-lg font-medium sm:font-bold text-md sm:text-lg cursor-pointer hover:bg-red-700 transition-colors duration-150">
            {isSignInForm ? "Sign In" : "Sign Up"}
          </button>
        </form>
        <p
